...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <a href="<?= base_url('/admin/categories') ?>" class="back-btn">← Retour à la liste principale</a>
        </div>
        ...
        <div class="form-container">
            ...
            <form action="<?= base_url('/admin/sous-categories/update/' . $category['id_categorie']) ?>" method="POST">
                <?= csrf_field() ?>
                    ...
                    <select id="parent_id" name="parent_id">
                        ...
                        <?php if (!empty($categories)): ?>
                            <?php foreach ($categories as $cat): ?>
                                <?php if ($cat['id_categorie'] != $category['id_categorie']): ?>
                                    <option value="<?= $cat['id_categorie'] ?>" 
                                        <?= old('parent_id', $category['parent_id'] ?? '') == $cat['id_categorie'] ? 'selected' : '' ?>>
                                        <?= esc($cat['nom']) ?>
                                    </option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                ...
                <!-- Actions -->
                 <div class="form-actions">
                    <a href="<?= base_url('/admin/categories/view/' . $category['parent_id']) ?>" class="btn btn-secondary">
                        Annuler
                    </a>
