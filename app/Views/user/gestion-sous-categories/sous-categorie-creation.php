...
<body>
    <div class="container">
        ...
        <div class="page-header">
            ...
            <h1 class="page-title">Créer une sous-catégorie</h1>
            <p class="page-subtitle">Ajoutez une nouvelle sous-catégorie principale pour organiser vos quiz</p>
        </div>
        ...
        <div class="form-container">
            <form action="<?= base_url('user/sous-categorie/store') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <p class="form-hint">-Une courte description pour aider les utilisateurs (optionnel)<br> -10 caracteres minimum</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="parent_id" name="parent_id">
                        ...
                        <?php if (!empty($categories)): ?>
                            <?php foreach ($categories as $category): ?>
                                <!-- pour ne pas la categorie selectee deuc fois  -->
                                <?php if($parentCategory['nom'] == $category['nom'] ) continue ?>
                                    <!-- OPTION : Afficher chaque catégorie -->
                                <option value="<?= $category['id_categorie'] ?>"
                                    <?= old('parent_id') == $category['id_categorie'] ? 'selected' : '' ?>>
                                    <?php //Si quelqu'un met du code malveillant dans le nom, il sera neutralisé ?>
                                    <?= esc($category['nom']) ?>
                                </option>
                    ...
                    <div class="form-hint">Sélectionnez une catégorie parente pour créer une sous-catégorie</div>
                </div>
                ...
                <div class="form-actions">
                    <a href="<?= base_url('/user/categorie/sous-categorie/' . $parentCategory['id_categorie']) ?>" class="btn btn-secondary">
                        Annuler
                    </a>
